...
?>
<div class="mb-3">
    <a href="/MVC_Autopartes/view/username/create.php" class="btn btn-primary">Agregar al inventario</a>
</div>
<table class="table">
    <thead>
        <tr>
    ...
    <tbody>
        ...
        <?php else: ?>
            <tr>
                <td colspan="3" class="text-center">No hay productos en el inventario</td>
            </tr>
        <?php endif; ?>
    </tbody>
</table>
